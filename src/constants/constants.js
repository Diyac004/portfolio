...
export const TimeLineData = [
  ...
  { year: 2024, text: 'Participated in SunHacks 2025 and successfully developed and deployed ORBIT with my fellow teammates within 24 hours', },
  // { year: 2021, text: 'Started my own platform', },
];
export const data = [
  { number: '83rd', text: 'Rank all over India in HPE CodeWars competition'},
  { number: '2nd', text: 'Rank in International Olympiad of Mathematics at the school level' },
